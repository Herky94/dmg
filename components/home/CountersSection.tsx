...
export default function CountersSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="pb-12 lg:pb-20 mt-0 md:-mt-40 lg:-mt-20 relative z-10"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 justify-items-center">
          {counters.map((counter, index) => (
            <div
              ...
              className={`flex flex-col justify-start p-[30px] lg:p-[50px] w-full max-w-[300px] lg:max-w-[360px] h-[300px] lg:h-[450px] rounded-[50px] lg:rounded-[70px] text-white ${
            ...
            >
              ...
              <div
                ...
                className="text-5xl lg:text-[64px] font-light leading-none mb-[10px]"
              >
                0{counter.suffix}
              </div>

              {/* Titolo */}
              <div className="text-2xl lg:text-[30px] font-light leading-tight mb-[20px]">
                {counter.title}
              </div>

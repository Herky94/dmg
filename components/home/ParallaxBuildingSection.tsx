...
export default function ParallaxBuildingSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollProgress = Math.max(
        ...
        Math.min(
          1,
          (windowHeight + offsetStart - rect.top) /
            (windowHeight + rect.height + offsetStart)
        )
      );
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-[80vh] w-full max-w-full overflow-hidden flex items-center justify-center pt-0"
    >

...
interface TurchiaInfoSectionProps {
  locale?: string;
  contactLabel?: string;
}

export default function TurchiaInfoSection({
  locale = "it",
  contactLabel = "CONTATTACI",
}: TurchiaInfoSectionProps) {
  return (
    <>
      ...
      <div className="bg-white py-[20px] pb-[15px]">
        <div className="container-dmg text-[20px] font-light">
          ...
          <span className="text-[#C34069]">DMG Turkey</span>
        </div>
      </div>
          ...
          <div className="lg:pl-[120px] space-y-[35px]">
            ...
            <div className="text-black text-[20px]">
              ...
              <p className="font-light">
                Teşvikiye mah. Valikonağı cad. No:74 D:7A,
                <br />
                Şişli, İstanbul
                <br />
                Turkey

...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-black/90 backdrop-blur-sm">
      <div className="w-full px-[30px] lg:px-20">
              ...
              >
                ...
                {item.hasDropdown &&
                  ...
                  openDropdown === item.name && (
                    <div className="absolute top-full right-0 mt-1 w-56 bg-black/90 backdrop-blur-sm rounded-md shadow-lg border border-gray-700">
                      <div className="py-2">

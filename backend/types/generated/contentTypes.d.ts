...
export interface ApiAreeTerapeuticheAreeTerapeutiche
  ...
  info: {
    displayName: 'Aree Terapeutiche';
    pluralName: 'aree-terapeutiches';
    singularName: 'aree-terapeutiche';
  };
  options: {
...
export interface ApiClassificazioniClassificazioni
  extends Struct.CollectionTypeSchema {
  collectionName: 'classificazionis';
  info: {
    displayName: 'Classificazioni';
    pluralName: 'classificazionis';
    singularName: 'classificazioni';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFormulazioneFormulazione
  ...
  info: {
    displayName: 'Formulazione';
    pluralName: 'formulaziones';
    singularName: 'formulazione';
  };
  options: {
    draftAndPublish: true;
  };
